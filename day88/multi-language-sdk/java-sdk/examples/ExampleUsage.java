    ...
    public static void main(String[] args) {
        ...
        try (LogPlatformClient client = new LogPlatformClient(config)) {
            ...
            List<LogEntry> batchLogs = Arrays.asList(
                new LogEntry(LocalDateTime.now(), "INFO", "Batch message 1", "batch-service", new HashMap<>()),
                new LogEntry(LocalDateTime.now(), "INFO", "Batch message 2", "batch-service", new HashMap<>()),
                new LogEntry(LocalDateTime.now(), "ERROR", "Batch error message", "batch-service", new HashMap<>())
            );
